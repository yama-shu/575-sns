...
| 項目 | 内容 |
| --- | --- |
| 状態 | **置換**（[ADR-0007](0007-hosting-conoha-vps.md) による） |
| 決定日 | 2026-08-06 |
| 置換日 | 2026-08-09 |
...
> **この ADR は [ADR-0007: ホスティング先を ConoHa VPS 単一ノードへ変更する](0007-hosting-conoha-vps.md) によって置換されました。**
> 本文は当時の判断の記録として、書き換えずに残しています。
>
> 7章に記した撤退条件（「3か月試して確保できなければ案4へ切り替え、本 ADR を『置換』とする」）を、
> 期限より前に発動したものです。理由は「確保できなかった」ではなく「待つ理由がなくなった」ことにあります。
> 経緯は [ADR-0007 の 1章](0007-hosting-conoha-vps.md#1-背景) を参照してください。
