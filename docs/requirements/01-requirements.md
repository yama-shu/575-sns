...
#### P1: 川柳好きの会社員（34歳・男性・メーカー勤務）

- 通勤中と昼休みにスマートフォンで SNS を見る
- サラリーマン川柳が好きで、自分でも思いつくが発表する場がない
- 既存 SNS に投稿しても文脈のない場所では反応がなく、続かなかった
- **575 に求めること**: 五七五が前提の場に投げれば、形式そのものが共通言語になる

#### P2: SNS 疲れの学生（21歳・大学生）

- タイムラインの情報量が多すぎて疲れ、SNS を開く頻度が落ちている
- 長文の議論・炎上を見たくない
- **575 に求めること**: 全部が17音なので、流し読みしても疲れない場

#### P3: 言葉遊びが好きな人（年齢不問）

- パズル・大喜利・縛りゲーが好き
- 制約があるほど燃える
- **575 に求めること**: 「この内容を五七五に収められるか」という挑戦そのもの
...
| 項目 | 理由 |
| --- | --- |
| 画像・動画の投稿 | 「言葉だけで勝負する」というコンセプトに反する |
